								...
								if (b.resultCode == "0") {
									if (b.logicCode == "0") {
										layer.alert("恭喜您，注册成功，点确定跳转!",{	icon : 1},function() {
											...
											window.location.href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx20be3e329920dba3&redirect_uri=http%3a%2f%2fwww.0352jdw.com%2fwechat%2fuser%2fjudgeSubscribe.action&response_type=code&scope=snsapi_userinfo&state=0#wechat_redirect";
										})
									} else {
